    ...
    <>
     <div className={`${darkMode ? 'dark bg-black' : 'light bg-white'}`}>
      <section id='hero' className='w-[95%] h-[600px] m-auto bg-cover bg-center rounded-xl flex flex-col justify-center items-start px-10 lg:px-28 gap-7 z-20' style={{backgroundImage: `url(${heroimg})`}}>
        <h1 data-aos='zoom-in' className='text-6xl text-white font-semibold font-serif pr-0 lg:pr-[500px] leading-[60px] lg:leading-[70px] '>Find Your Next Home in RMT</h1>
        <p data-aos='zoom-in' className='text-xl text-white font-serif pr-0 lg:pr-[500px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat officia ea similique officiis.</p>
      </section>
      {/* form starts from here */}
      <div  className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} z-10`}>
          <div   id='form' className={`${darkMode ? 'dark bg-gray-800' : 'light bg-white'} w-full lg:w-[70%] m-auto grid grid-cols-1 lg:grid-cols-4 justify-center items-center gap-6 p-8 -mt-14 rounded-xl`}>
